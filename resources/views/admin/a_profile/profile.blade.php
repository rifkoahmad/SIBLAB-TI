                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-3">
                        <div class="text-center mb-5">
                            <img src="{{ asset('logo/logo-hitam.png') }}" width="130"
                            style="height: 120px;position: absolute;bottom: -21px;right: 40px;" alt="modernize-img"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="form-control-static">
                                                            {{ $userPegawai->nama ?? 'Data Tidak Ada' }}
                                                        </p>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="exampleInputtext1" class="form-label">Jabatan
                                                            :</label>
                                                        <p class="form-control-static">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="form-control-static">
                                                            {{ $userPegawai->email ?? 'Data Tidak Ada' }}
                                                        </p>
                                                    </div>
                                                    <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <p class="form-control-static">
                                                            {{ $userMahasiswa->nama ?? 'Data Tidak Ada' }}
                                                        </p>
                                                    </div>
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="exampleInputtext1" class="form-label">Angkatan
                                                            :</label>
                                                        <p class="form-control-static">
                                                            {{ $userMahasiswa->angkatan ?? 'Data Tidak Ada' }}
                                                        </p>
                                                    </div>
                                                    <div class="mb-3">
