...
<head>
    ...
    <title>SIBLAB-TI</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('logo/logo-hitam.png') }}" />
    <!-- Bootstrap Icons-->
...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">"Jika Anda menjual produk fisik, Anda memiliki banyak sisi positif dan
                        ketidakpastian Q4, tetapi sekarang Anda harus mengelola uang Anda untuk mencapai K4 sehingga
                        Anda dapat berinvestasi dalam membangun inventaris untuk kinerja yang berlebihan."</p>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-white-75 mb-4">Sebuah Website atau platform yang memudahkan pengguna dalam melakukan
                        peminjaman barang di labor TI</p>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi1.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi1.PNG" alt="Leader Team"
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi2.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi2.PNG" alt="Member Team"
                                style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi3.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi3.PNG"
                                alt="Member Team" style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi4.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi4.PNG"
                                alt="Member Team" style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi6.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi6.PNG"
                                alt="Member Team" style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/logoprodi7.PNG" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/img/logoprodi7.PNG"
                                alt="Member Team" style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/team/photo1.jpg" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/kardusmah.jpeg" alt="Leader Team"
                                style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/team/photo2.jpg" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/oppa.jpeg" alt="Member Team"
                                style="width: 150px; height: 150px;">
                        </a>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/team/photo3.jpg" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/onepiece.jpeg" alt="Member Team"
                                style="width: 150px; height: 150px;">
                        </a>
                        <h3 class="text-white h4 mb-2">Member Team</h3>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <a href="assets/img/team/photo4.jpg" title="Team Member Name">
                            <img class="img-fluid rounded-circle mb-2" src="assets/orangganteng.jpeg"
                                alt="Member Team" style="width: 150px; height: 150px;">
                        </a>
                        <h3 class="text-white h4 mb-2">Member Team</h3>
            ...
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/1.jpg"
                        title="Teknologi Infomasi kembali membuat prodi baru viral">
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Copyright &copy; 2024 - kelompok 3 PBL 2C</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
